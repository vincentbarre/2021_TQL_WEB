...
class Utilisateur
{
    ...
    public function getAuth($login, $password)
    {
        ...
        if (!is_null ($login) && !is_null ($password)) {
            ...
            $sql = "SELECT * FROM UE52_Users WHERE login = :login AND pass = :pass";
            $stmt = $db->prepare ($sql);
    ...
    public function createUser($login, $password, $mail, $tel)
    {
        ...
        $sql = "INSERT INTO UE52_Users VALUES ('$login', '$pass', '$mail', '$tel')";
    ...
    public function updateUser($password, $mail, $tel)
    {
        ...
        $sql = "UPDATE UE52_Users SET pass = '$pass', mail = '$mail', tel = '$tel' WHERE login = '$this->login'";
